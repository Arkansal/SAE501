 ...
 */
final class Version20251210103255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, image LONGTEXT NOT NULL, date DATE NOT NULL, author VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE favorite_article (article_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_5F6EA0087294869C (article_id), INDEX IDX_5F6EA008A76ED395 (user_id), PRIMARY KEY (article_id, user_id)) DEFAULT CHARACTER SET utf8mb4');
