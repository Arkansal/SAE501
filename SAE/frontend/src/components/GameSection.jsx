  ...
  return (
    <div className="game-section">
      <div className="game-section-header">
        ...
        <h3 className="game-section-title">Mini-jeux</h3>
              ...
              <div className="game-image-container">
                ...
                {game.status === 'coming-soon' && (
                  <div className="game-overlay">
                    <span className="game-overlay-text">À venir...</span>
                  </div>
                )}
              </div>
              <div className="game-info">
                <h4 className="game-name">{game.name}</h4>
                <span className="game-details">Détails</span>
              </div>
            </Link>
          ))}
        </div>
      </div>
       <Link to="/games" className="game-section-see-more" onClick={onItemClick}>
          Voir plus +
        </Link>
    </div>
  )
