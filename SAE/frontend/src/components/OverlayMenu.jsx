        ...
        <div className="nav-menu-header">
          ...
          <button className="nav-close-button" onClick={onClose}>
            <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="m8.464 15.535l7.072-7.07m-7.072 0l7.072 7.07"></path>
            </svg>
          </button>
        </div>
        ...
        <div className="nav-menu-scroll-container">
          ...
          <div className="nav-menu-section">
            <div className="nav-menu-grid">
              <Link to="/" className="nav-menu-item" onClick={onClose}>
                ...
                <span className="nav-menu-text">Carte</span>
              </Link>
              
              <Link to="/scan" className="nav-menu-item" onClick={onClose}>
                <span className="nav-menu-icon">
                ...
                <span className="nav-menu-text">Scan moi</span>
              </Link>
              
              <Link to="/partners" className="nav-menu-item" onClick={onClose}>
                <span className="nav-menu-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                ...
                <span className="nav-menu-text">Partenaire</span>
              </Link>
              
              <Link to="/donation" className="nav-menu-item" onClick={onClose}>
                <span className="nav-menu-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                ...
                <span className="nav-menu-text">Donation</span>
              </Link>
              
              <Link to="/about" className="nav-menu-item" onClick={onClose}>
                <span className="nav-menu-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                ...
                <span className="nav-menu-text">Artémis</span>
              </Link>
              
              <Link to="/contact" className="nav-menu-item" onClick={onClose}>
                <span className="nav-menu-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                ...
                <span className="nav-menu-text">Contact</span>
              </Link>
            </div>
          </div>
          ...
          <div className="nav-menu-section nav-user-section">
            <div className="nav-user-info">
              ...
              <span className="nav-user-name">Nom d'utilisateur</span>
            </div>
