 ...
 */
final class Version20251126150147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT NOT NULL, common_name VARCHAR(100) DEFAULT NULL, scientific_name VARCHAR(200) NOT NULL, family VARCHAR(100) DEFAULT NULL, type VARCHAR(100) DEFAULT NULL, image LONGTEXT NOT NULL, extinct_level VARCHAR(50) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE environment (environment_id VARCHAR(10) NOT NULL, environment_name VARCHAR(50) NOT NULL, environment_type VARCHAR(255) DEFAULT NULL, PRIMARY KEY (environment_id)) DEFAULT CHARACTER SET utf8mb4');
